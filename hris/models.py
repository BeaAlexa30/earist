...
class Employee(models.Model):
    ...
    #pds2 Civil Service Eligibility row 1
    ...
    #pds2 Civil Service Eligibility row 2
    ...
    #pds2 Civil Service Eligibility row 3
    ...
    license_date3 = models.DateField(null=True, blank=True)
     ...
     #pds2 Civil Service Eligibility row 4
    ...
    #pds2 Civil Service Eligibility row 5
    ...
    #pds2 Civil Service Eligibility row 6
    ...
    #pds2 Civil Service Eligibility row 7
    ...
    #For PDS3 VI row 1
    organization_name_1 = models.CharField(max_length=150, blank=True, null=True)           
    ...
    #For PDS3 VI row 2
    organization_name_2 = models.CharField(max_length=150, blank=True, null=True )          
    ...
    #For PDS3 VI row 3
    organization_name_3 = models.CharField(max_length=150, blank=True, null=True )          
    ...
    #For PDS3 VI row 4
    organization_name_4 = models.CharField(max_length=150, blank=True, null=True )          
    ...
    #For PDS3 VI row 5
    organization_name_5 = models.CharField(max_length=150, blank=True, null=True )          
    ...
    #For PDS3 VI row 6
    organization_name_6 = models.CharField(max_length=150, blank=True, null=True)           
    ...
    #For PDS3 VI row 7
    position_nature_of_work_6 = models.CharField(max_length=150, blank=True, null=True)     
    ...
    #For PDS3 VII row 1
    title_of_program_1 = models.CharField(max_length=150, blank=True, null=True)           
    ...
    #For PDS3 VII row 2
    title_of_program_2 = models.CharField(max_length=150, blank=True, null=True)            
    ...
    #For PDS3 VII row 3
    title_of_program_3 = models.CharField(max_length=150, blank=True, null=True)             
    ...
    conducted_by_3 = models.CharField(max_length=150, blank=True, null=True)
     ...
     #For PDS3 VII row 4
    title_of_program_4 = models.CharField(max_length=150, blank=True, null=True)            
    ...
    #For PDS3 VII row 5
    title_of_program_5 = models.CharField(max_length=150, blank=True, null=True)             
    ...
    #For PDS3 VII row 6
    title_of_program_6 = models.CharField(max_length=150, blank=True, null=True)             
    ...
    #For PDS3 VII row 7
    title_of_program_7 = models.CharField(max_length=150, blank=True, null=True)             
    ...
    #For PDS3 VIII row 1
    non_academic_distinctions_1 = models.CharField(max_length=150, blank=True, null=True)    
    ...
    #For PDS3 VIII row 2
    non_academic_distinctions_2 = models.CharField(max_length=150, blank=True, null=True)   
    ...
    #For PDS3 VIII row 3
    non_academic_distinctions_3 = models.CharField(max_length=150, blank=True, null=True)   
    ...
    #For PDS3 VIII row 4
    non_academic_distinctions_4 = models.CharField(max_length=150, blank=True, null=True)    
    ...
    #For PDS3 VIII row 5
    non_academic_distinctions_5 = models.CharField(max_length=150, blank=True, null=True)    
    ...
    #For PDS3 VIII row 6
    non_academic_distinctions_6 = models.CharField(max_length=150, blank=True, null=True)   
    ...
    #For PDS3 VIII row 7
    non_academic_distinctions_7 = models.CharField(max_length=150, blank=True, null=True)     
